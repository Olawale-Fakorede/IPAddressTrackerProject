...
const Displays = ({ ipAddress, location, timezone, isp }) => {
  return (
    <div className='w-4/5 md:w-min md:left-14 xl:left-32 lg:w-fit md:h-44 md:text-center rounded-lg absolute top-36 md:top-32 left-10 bg-white z-10 flex flex-col sm:flex-row container gap-4 md:gap-16 p-4'>
